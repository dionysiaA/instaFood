...
const shutDown = () => Promise.resolve().then(() => server && new Promise(resolve => server.close(resolve))).then(() => Promise.all([() => db && db.destroy(), () => redis && new Promise(resolve => redis.quit(resolve))]));
